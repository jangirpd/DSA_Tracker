				...
				<Fade duration={500}>
					...
					<div className="container my-5">
						<h2 className="text-center">
							<a href="http://localhost:3000/">DSA Tracker</a> is your personal web-based progress tracker based on <br></br>
							<i>
								<a
						...
						<h4 className="text-center my-5">
							Project by{" "}
							<a href="https://www.linkedin.com/in/priyanshu-jangir/" target="_blank" rel="noopener noreferrer">
								Priyanshu
							</a>{" "}
